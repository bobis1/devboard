...
#This was taken out of my fantasy console project
#Todo: rewrite undo logic to work without Globals.ram, Work on a way to attach the sprite to the devboard.
var grid_size = 8
var sprite_data = []
